...
echo "$merah (DIREITOS TOTAIS AO OLUAS) ";
//echo file_get_contents("LINK PASTEBIN SEBAGAI INFO");
echo " \n";
echo "$hijau Redes Sociais : \n";
echo "$hijau Instagram : @oluas_arieiv \n";
echo "$hijau Youtube: Oluas Arieiv \n";
echo " \n \n";
echo "$biru -=< Trafégo >=-\n  ";
echo ' URL_Website : ';
$jnck_url = trim(fgets(STDIN));
echo ' Número de Visitas : ';
...
curl_setopt($ch, CURLOPT_REFERER, 'https://sublimefinancas.com/pagamento-de-dividendos-em-2022-o-que-e-e-como-funciona');
...
$end = time()-$start;
echo "$pituh \n O processo acabou em ".$end." Segundos";
echo "$pituh \n Site Alvo :  $jnck_url";
echo "$pituh \n hahaha";
